...
export function VisitChartSkeleton() {
  return (
...
export function LatestUsersRowSkeleton() {
  return (
...
export function FormCardSkeleton() {
  return (
    <Skeleton className="border-primary-/20 h-48 w-full border-2">
      <Skeleton />
    </Skeleton>
  );
}
